...
#### Related documents elsewhere in packet
...
- **2-Day Venture** (co-curricular, 2022–present) — weekend events coaching up to eight student teams.
- **MBA program in entrepreneurship** (2024) — _see International Business; could alternatively sit under Reference._
- **EGR 440** - Engineering Entrepreneurship
...
- **2025–26 (Year 3):** continued growth; MSU students reached the finals for the first time, placing fifth.
...
> [!quote] Ilana Stonebraker → Terence O'Neill, Heather Howard — July 5, 2022 Hi Terence,
> 
> Seeing you at ALA reminded me that I never responded! I'd love to help.
> 
> Ilana

> [!quote] Terence O'Neill → Ilana Stonebraker, Heather Howard — July 7, 2022 Great. One of the small advantages of showing up at conferences! It was good to see you and your family, if very briefly!
> 
...
> [!quote] Terence O'Neill → Ilana Stonebraker, Heather Howard — August 22, 2022 Hello again!
> 
> Since we started this poll in the distant past, I'm going to say it's no longer relevant. When would you all like to meet? It could be later in the semester, (early November?) if that works for you two.
> 
> Terence

> [!quote] Ilana Stonebraker → Terence O'Neill, Heather Howard — August 22, 2022 Hi Terrence,
> 
> It's first day of classes here, so probably next week I will know my schedule better, but early November sounds great.
> 
> Ilana

> [!quote] Heather Howard → Ilana Stonebraker, Terence O'Neill — August 22, 2022 Same here, that sounds great.
> 
> HH

> [!quote] Terence O'Neill → Heather Howard, Ilana Stonebraker — October 3, 2022 Hi Heather & Ilana,
> 
> I hope you are enjoying some crisp early fall weather. Good weather for good beer and getting outside!
> 
...
> [!quote] Terence O'Neill → Heather Howard, Ilana Stonebraker — October 3, 2022 Thank you both for the quick response!
> 
> Let's go with Thursday, November 3 at 2 pm. We can use this Zoom room, which is recurring in case that ends up being helpful: _[Zoom link redacted]_
> 
> Talk to you both in November.
> 
> -Terence

> [!quote] Ilana Stonebraker → Terence O'Neill, Heather Howard — October 2022 Yep! And you can see she may be interested in judging as well.
> 
> Ilana

#### Artifacts:
- [[MOC Librarian III]]
- ### Broad 360 credit verification — Data Visualization Basics workshop
...
> [!quote] Email to Director, Undergraduate Student Engagement, Broad College of Business — February 10, 2026
> Hi [redacted],
>
> I didn't know what steps to take for verifying that students attended. Here is a list of their netids:
>
> *[Six student netids redacted]*
>
...
>
> Terence
- > [!quote] Terence O'Neill → Laurel Ofstein, Lori Fischer, Paul Jaques, Ken Szymusiak, Aubrey Haase (Burgess Institute) — December 7, 2023
> Hi everyone,
>
...
> [!quote] Aubrey Haase (Events & Engagement Manager, Burgess Institute) → Terence O'Neill — December 2023
> Thanks for the information, Terence! We'd be happy to promote. I've added Aaryn and his team to ensure that this is included in our event line-up for promotion across our platforms in the coming months.
>
> Happy Holidays!
- _[Growth over three years — registration figures, results]_
- _[Integration with the Broad College]_
- > [!quote] Ahmed Bouzid → Zoe Mayhook and team — February 2025
> Hi Zoe and Team,
>
> Thank you for your kind words -- and many thanks for including me in this event in the first place. I enjoyed the experience very much.
>
> Many of the students have already reached out to me, so that's great. 🙂
>
> Thanks again.
>
> Best,
>
> [Ahmed Bouzid (external) →](https://www.linkedin.com/in/ahmedbouzid/)

#### Related content in other criteria

- Letter of reference: Zoe Mayhook
- Cr. II: _Building a regional library-led case competition_ (Ticker, 2025)

## Reference & Research Consultation

Reference is, with instruction, one of the two main ways I contribute to entrepreneurship at MSU. I cultivate direct pathways for students to reach me, and a key one is the Burgess Institute pipeline: beginning spring 2022, teams are directed to consult with me early in their venture planning (an arrangement developed with Lori Fischer). This resulted in an increase in volume — 75 consultations in 2022–23, 73 in 2023–24, 54 reference questions in 2024–25, and 32 in 2025–26, with most students now scheduling directly with me rather than through another channel. (The recent decline is something I want to understand; I suspect student information-seeking patterns are shifting dramatically.)
The impact often surfaces years later. Ventures I consulted with have gone on to real outcomes: TrailEagle Packs (2022) ran a successful Kickstarter and competed nationally at SXSW; Protein Pints (2023) expanded to 197 Meijer stores; and earlier consultations connect to brick-and-mortar openings (Sweet Encounter Bakery) and continued investment (TheraB).

#### Artifacts

- Product Center — collection of responses: [Drive folder (external) →](https://drive.google.com/drive/folders/14OxTX9ICv5o4oiaYa2wOjuv17KhLeQF7)
- MBA "Sparty Green" — international library resources — _[add]_
...
As part of the Gast team I coordinate our engagement with introductory business courses (BUS 100/101), contribute to database licensing discussions, recommend books, maintain coverage during absences, and steward subject content. Recent operational improvements include the team's 2024 adoption of **Trello** to track and claim reference questions and confirm coverage (paired with Teams for discussion), and investment in **video creation and editing** to align with the Broad College's emphasis on hybrid and online delivery.

#### Artifacts

- Database chart update — _[add]_
- Diversity content for LibGuides (2023) — _[add]_
- Love Data Week 2024 — _[add]_
- Love Data Week 2026: "Introduction to Business Data Visualization" (with Eli Wachter; promoted via Broad 360) — _[add]_
...
- Public event description (MSU Libraries booking system) — _[add]_
- Recruitment correspondence (incl. the iterative invitation to Prof. Bauer) — _[add, redacted to role where appropriate]_
- Final panel questions (developed across multiple rounds) — _[add]_
- Event photographs (attendance and panel) — _[add]_
- Public LinkedIn reflection by panelist Sara Rezaeimanesh (three weeks post-event), crediting the organization — _[add link]_

### CESRL debate LibGuide

For a CESRL-run Broad College student debate — "Is nuclear power an appropriate option for data centers?" — I compiled a LibGuide with librarians Colleen Lyon and Eric Tans, balancing expert, catalog-driven resources with current-debate perspectives on a timely topic.

#### Artifacts

- https://libguides.lib.msu.edu/nuclearfordatacenters
...
- **Deconstruction / materials-reuse project** (with Matt Hall; wrapped May 2023), later integrated into MSU Commons.
...
> [!quote] I would also like to THANK Terence O'Neill, who has shared his expertise with REI to provide research and resources such as Humanities Commons and Google Scholar. These platforms have allowed REI to disseminate [...] projects across the state, nationally, and worldwide — in the thousands!

#### Artifacts

- # Reclaimed Timber Grading Research — CCED (November 2022)

Correspondence documenting in-depth reference support for the Center for Community Economic Development on the feasibility of grading reclaimed timber for structural reuse in Michigan. The question had no clean answer — Terence's synthesis established that no robust grading ecosystem for reused timber exists in Michigan, then mapped the adjacent landscape: grading standards and processes, international precedents (Australia/NZ, UK), regional organizations and firms, and MSU-connected expertise. The deliverable was handed to CCED research assistants as a structured starting point for their own investigation.

---

## Thread (chronological)

> [!quote] Terence O'Neill to Matt Hall and Nathaniel Hooper (CCED) — November 8, 2022 I ended up going down a bit of a rabbit hole on this one, apologies for the delay here. Here's what I found, since it's not a clean answer: there doesn't appear to be a robust or possibly even existing ecosystem for grading timber for re-use in Michigan. Please peruse the below notes and links, but this use case from Ohio might be useful to consider — [(external) →](http://yr-architecture.com/reclaimed-timber-preparing-reclaimed-wood-for-reuse/)
> 
...
> [!quote] Matt Hall (Undergraduate Research Assistant, Center for Community Economic Development) — November 8, 2022 Wow! This is excellent! Thank you so much for this thorough review, we will get our research assistants looking at these sources ASAP.

#### Related sections:

- Criterion I → Community Economic Development
- Criterion I → Reference
- Quote from a CCED colleague on digital scholarship / dissemination — _[above; confirm attribution]_
# REI Co-Learning Plans on Humanities Commons — Partner Recognition

Correspondence from a colleague at the Regional Economic Innovation (REI) program, MSU Center for Community and Economic Development, recognizing Terence's role in connecting REI to Humanities Commons as a repository platform for its Co-Learning Plan series. The introduction — brokered between REI and a member of the Humanities Commons team — resulted in 135 Co-Learning Plans uploaded, with over 3,000 downloads and/or views within the first six months.

> [!quote] REI program colleague (MSU Center for Community and Economic Development) to Terence O'Neill — _[date]_ I just saw that you will not be able to attend the January meeting. So, I wanted to be sure to say THANK YOU for introducing me to _[Humanities Commons team member]_ — and REI to Humanities Commons! Our current data shows that there have been over 3,000 downloads and/or views of the 135 Co-Learning Plans that have been uploaded — in only six months! You have been a great partner to work with and I appreciate your engagement with REI.
...
> [!quote] Terence O'Neill to Bill Blackerby and Randy Yagiela (Lenawee Now), cc Arnold Weinfeld (MSU) — June 3, 2024 I hope you are both doing well. Arnold is cc'd here as well, as he offers some very helpful information. You probably already know at least some of what is here, but hopefully something is new and useful. Here is a summary:
> 
...
> - Ascendium is a grant-giving organization focused on positive pathways for adults, and they have had programs focused on rural community colleges in the past — [(external) →](https://www.ascendiumeducation.org/)
>     - Ascendium has hosted Michigan meet and greets on the topic of strengthening bonds between community colleges (Strengthening MiWorkforce Pathways Project), but it doesn't seem to be very active right now — [(external) →](https://www.ascendiumphilanthropy.org/news/news/diverse-group-works-to-strengthen-pathways-at-michigan-community-colleges/)
>     - While the above blog-post link isn't terribly useful, it does list some parties who may be interested in this topic:
>         - Kristin Carey Li, project manager in the Institutional Effectiveness Office at Oakland Community College (OCC)
>         - Kimberly Hurns, executive vice president for instruction and academic services at Washtenaw Community College
...
> [!quote] Bill Blackerby (Lenawee Now) to Terence O'Neill and Arnold Weinfeld — June 2024 Thanks very much. Both for these valuable leads and for your interest and support.
> 
...
> [!quote] Terence O'Neill — February 2024 I would be happy to speak with you all again, that was a pleasure.
> 
...
- Cr I IBSO Slides https://docs.google.com/presentation/d/1ZvywFAAYaYnquWdJx5qwtVHM21VzlF1n/edit?usp=drive_link&ouid=111995156214073893299&rtpof=true&sd=true

#### Related sections:

- Criterion I → International Business
- Criterion I → Gast Business Library
- Criterion I → FSA Japan (cross-reference: Criterion II — FSA Japan 2024 Circular Economy materials)

# Library Support — MBA Innovation Project (Extreme Green / TechSmith, Summer 2024)

Correspondence documenting library support for the Full-Time MBA capstone corporate innovation challenge, co-instructed by Ken Szymusiak (Burgess Institute) and Shana Redd-Sleep (University of Nebraska Omaha), partnered with TechSmith. The request — baseline market intelligence for foreign-market sales and marketing strategy — was scoped in July and delivered as country briefing PDFs for 12 markets. The confirmed country list arrived August 12; the complete set of briefings was delivered August 13, three days ahead of the August 16 go-live.
...
> [!quote] Ken Szymusiak (Managing Director – Academic Programs, Burgess Institute) to Laura Walesby and Terence O'Neill — July 18, 2024 I think you are both aware of the series of Extreme Green projects that have become a hallmark of the FTMBA experience at Broad over the last 8 (or so) years. Shana and I co-instruct the final experience which is a corporate innovation challenge that we run with an external partner/company. This year we will be working with TechSmith on a challenge that focuses on helping them navigate marketing and sales strategies in foreign markets. We are still waiting on the list of targeted geographies, but we were wondering if we might be able to work with the library to provide each team with some baseline information for each market?
> 
> We're imagining:
> 
...
> [!quote] Laura Walesby (MSU Libraries) to Ken Szymusiak — July 19, 2024 Yes, that is something that we can do! Terence is out of the office, but I'd be happy to meet with you and Shana in the meantime to determine what you'd like and how best to deliver it. As an example of something similar, we've prepared country briefings for students studying abroad in the recent past:
> 
> - Denmark — [(external) →](https://libguides.lib.msu.edu/denmark)
> - Germany — [(external) →](https://libguides.lib.msu.edu/germany)

> [!quote] Terence O'Neill to Shana Redd-Sleep and Ken Szymusiak — August 6, 2024 I shared the draft resources with you last week. Please let me know what feedback you have, and if you have a list of countries I can start working on. I'm also curious about the timeline you have for when you need this by.

> [!quote] Terence O'Neill — August 7, 2024 You are welcome. Please feel free with any feedback or questions, and if you have a list of countries, I can start making versions of this for the others.

> [!quote] Ken Szymusiak — August 12, 2024 _(marked High Importance)_ Sorry for the delay on this, but we got the confirmed list back from TechSmith. These are not in a prioritized order. I know this is putting you up against a time crunch so adjust the data dump as needed. We'd like to go live with these on Friday (8/16) but alternatively we could go live on 8/19 at the latest (or anytime in between) if that is not doable. We really appreciate your help.
> 
...
> [!quote] Terence O'Neill — August 13, 2024 Here is the link to a Google Folder with PDFs for each of the 12 countries. I have the docs in OneDrive if I need to change anything and update the PDF, but my fingers are crossed that these are ready to go!

> [!quote] Ken Szymusiak — August 13, 2024 Wow Terence! Thank you so much for your support!

> [!quote] Shana Redd-Sleep, Ph.D. (Assistant Professor of Marketing, University of Nebraska Omaha) — August 13, 2024 Terence, this is awesome! Thank you so very much!

#### Related sections:

- Criterion I → Gast Business Library / Entrepreneurship support
- Criterion I → International Business
- Collaboration with Ken Szymusiak (Burgess Institute) — see also letter of recommendation
- _[IBC / CIBER engagement]_
- _[International Business Student Association presentation]_

#### Related content in other criteria

- Cr. II: FSA Japan courses (2023, 2024, 2026); Japanese-language study
- Cr. III: MSU Japan Council
...
- Job descriptions (roles created) — _[add]_
- Makerspace strategic-planning retreat — _[add]_
...
- https://docs.google.com/document/d/17OEgiOOSwDHGnZYFqLTM8nKNmYY2qQrO/edit?usp=sharing&ouid=111995156214073893299&rtpof=true&sd=true
- 