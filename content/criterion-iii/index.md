...
My MSU Libraries service has been quite varied in this time under review, via service on Space Planning Committee, two job search committees, one area that stands out is my role with the MSU Libraries Strategic Planning Implementation Team (hereafter, Implementation Team). 
I was first a member of the Implementation Team (2024) and then Chair of the Implementation Team (2025). During this time I helped lead and contributed to a number of important developments as MSUL continues to develop its practices relating to strategic planning. The artifacts I've compiled here help indicate the important collaborative work that was undertaken to refresh the Strategic Plan and further a culture of strategic planning at MSUL. 
By a culture of strategic planning, I am referring to practices relating to how organizations set goals, organize themselves to carry out those goals, measure progress towards those goals, and communicate how those goals have been met. My engagement with the work of the Strategic Plan meant was partly based in strategic planning for the makerspace and Digital Scholarship Services units.
To indicate these contributions, I have brought together the following artifacts. Each artifact will have annotation including the work of my specific contribution. 
...
- Member and Affirmative Action Advocate, Engineering and Innovation Librarian Search Committee (2022)
- Mentor, MSU Libraries Mentorship Program (2023-2024)
- Member, Engineering and Innovation Librarian Search Committee (2023)
- Member, Library Space Planning Committee (2023)
# MSU Service
## Community Center for Economic Development
I have served with the Community Center for Economic Development (CCED) in a varying capacities for several years. This has led to my increasing knowledge conversance on important issues, including circular economy and AI. These topics then show up throughout my work in different ways, such as circular economy becoming a major component of my 2024 FSA Japan course (Criterion II). My relationship to CCED also leads to embedded reference interactions on teams and projects. See Criterion I > Reference for instances of that work.
In my presence on these various boards, I have moderated multiple conference sessions, particularly around topics of interest such as AI and Circular Economy; and consulted with Vice Provost for University Outreach and Engagement Kwesi Brookins as he is now beginning the process of recruiting a new head of the CCED following longstanding and founding Head Rex LaMore's retirement.
- Member, CCED Consultative Panel (2013-Present)
- Innovate! Michigan moderator (2022)
- Member, Innovate! Michigan event coordinating committee (2023)
- Innovate! Michigan moderator (2024)
- Innovate! Michigan moderator (2025)
- CCED Faculty Committee (2025-Present)
## Other MSU Committee Work
- Member, All University Traffic and Transportation Committee (AUTTC) (2022)
- Search Committee: Global Programs Coordinator, Division of Curricular and Co-Curricular Initiatives (Undergraduate Education, Office of the Provost)(2025)
- MSU Japan Council (2025 - Present)
# External Service
## American Library Association - Business and Reference Services Association (BRASS)
### BRASS Education
Working with BRASS Education has been an important part of my transition back to being a business librarian. This work with BRASS partly reflects an understanding of what committee work is for, in terms of how it serves the broader professional community. It's a place where we learn about what is going well at other institutions, where high-level professionals can share their expertise and help round out their skillsets or develop a new program offering for their home institution. As such, these professional communities need to actively choose to be nimble and to dedicate resources to again becoming what's needed by its members.
As chair of the Education Committee of BRASS, I was given the opportunity to update that committee's orientation. Like many institutions, the recent history of BRASS has had momentous shifts, and the charge reflected out-dated understandings of the work needed. 
In 2025-2026, as BRASS Chair, I facilitated the following updates to the Charge:
- Sunsetting a recurring 'award', "Best of the Business Web", which suffered from a number of issues: ill-fit with Education's broader mandate; lack of appropriate distributions methods for connecting with readers.
### BRASS Committee work relevant to AI
I have made two substantive contributions I've made to help BRASS members engage with Artificial Intelligence. I was a primary contributor to the writing adn formation of the BRASS libguide on AI, which is a highly viewed libguide published by BRASS. For that work, I authored two pages, the front page, and 'Research.'
...
- Member, Conference Planning Committee, 2022-2023
- Recruited candidate, Chair of BRASS Executive, three year appointment. (2026)
	- Though I didn't win this election, my recruitment and nomination are indications of my standing in the BRASS Community
### BRASS Mentorship
Over the five mentees I have had over the past three years, I have developed a loose system that I believe supports early career professionals in responding to the unique challenges of engaging with the work of being a new business librarian professional. Both BRASS and MSUL mentorship typically have 8-12 meetings spaced over an academic year.
This systems foregrounds the Logic Model framework, which was developed by the Kellogg Foundation to help its grantees communicate how their activities build towards their desired impacts. Though limited as all frameworks inevitably are, the Logic Model encourages ways of thinking and working that are beneficial to early career librarians:
- Impact. Logic Models require mapping how day-to-day efforts build towards shared goals and desired impacts.
- Timeline. Different types of work have different maturity cycles, and new initiatives have activities that are important to make visible when accounting for your work. 
- Telling the story. Related to both of the above, Logic Models can help connect how quiet, slow, or painstaking work gradually builds towards desired outcomes.
Another characteristic I try to fold into my mentorship programs is to bring mentees further into the peer community, such that they can see how their own issues manifest to varying extents with others. 
To structure these programs, I generally follow this loose structure:
- One: Introductions, development of points of focus
- Two: Logic Models introduction
- Three: They share out their own Logic Model, with special attention to specific topics they wish to focus on
- Four: We introduce an expert peer on one of their chosen issues
- Five: Make sure we're checking in, giving space to vent and share context
...
> **Re:** Meet with new mentee?
> Hi (name redacted),
>I hope you are doing well! I am working with another mentee via BRASS, and we were just talking about curriculum mapping and discovering the right places to work into the curriculum. It reminded me of your experience at (redacted). Would you be willing to come to one of our meetings and talk about your work? You don’t need to prepare anything, but it’s great to hear from different people.
Just in case it works for you, our next meeting is Thursday, March 13, at 3 pm, though we’d be happy to set up another time.  
...
> **Re:** Meet with new mentee?
> Hi Terence,
It’s great to hear from you! I’m currently free during your next meeting, so I’d be happy to come and connect with you and your current BRASS mentee and share my experience with curriculum mapping.
Happy Friday,
>(redacted)
>
>**From:** (Then current mentee)
> **Date:** March 2025
> **Re:** Meet with new mentee?
> (redacted)
...
- Cr. II: "Back to Business" Logic Model Presentation for BRASS
- Cr III: Logic Models DSS Meris Presentation
## American Library Association - Reference and User Services Association
- Member, RUSA Annual Conference Review Committee (2023)
- Chair, Member, RUSA Annual Conference Review Committee (2024, 2025)
For these roles, I coordinate reviewing all of the submissions for the ALA Annual Conference in the RUSA Sections. These include Conference Presentations, but also 
